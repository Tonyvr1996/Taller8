...
public class GuiaRemision extends ComprobanteElectronico {
    ...
    public GuiaRemision(String destino, String placaVehiculo, ArrayList<String> listaProductos, String detallesEmisor, String numeroAutorización, String claveAcceso, LocalDate fecha, String descripcionComprobante) {
