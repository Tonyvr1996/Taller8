...
public class NotaCredito extends ComprobanteElectronico{
    ...
    public NotaCredito(String cliente, String codigoComprabante, String detalleModificacion, double valorPagar, String detallesEmisor, String numeroAutorización, String claveAcceso, LocalDate fecha, String descripcionComprobante) {
