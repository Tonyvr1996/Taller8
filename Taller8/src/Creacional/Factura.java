...
public class Factura extends ComprobanteElectronico {
    ...
    public Factura(String nombreCliente, String codigo, ArrayList<String> listaProductos, double total, String detallesEmisor, String numeroAutorización, String claveAcceso, LocalDate fecha, String descripcionComprobante,Adicionales ad) {
